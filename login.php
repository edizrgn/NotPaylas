                ...
                <div class="panel-card mt-5">
                    ...
                    <form action="login.php" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="email" name="email" autocomplete="username" inputmode="email" autocapitalize="none" spellcheck="false" required placeholder="ornek@email.com">
                        </div>
                        <div class="mb-4">
